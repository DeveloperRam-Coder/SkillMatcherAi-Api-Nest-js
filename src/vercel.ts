...
// Create a single Express server instance for serverless
...
// Prepare the server once during cold start
...
// Export the Express server. Vercel will treat this as a request handler.
